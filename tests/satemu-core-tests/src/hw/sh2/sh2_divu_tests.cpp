...
constexpr auto testdata = {
    ...
    TestData{.input = {0xEC8E17C3, 0xE5CA8598, 0xD2F95122, 0x88356EF5, 0x206BC53E, 0x711E5D3A, 0x01},
             .output32 = {0xEC8E17C3, 0x00000002, 0x00000002, 0xF9DD219C, 0x00000002, 0xF9DD219C, 0x01},
             .output64 = {0xEC8E17C3, 0x7FFFFFFF, 0x7FFFFFFF, 0x041E8A10, 0x7FFFFFFF, 0x041E8A10, 0x01}},
};
