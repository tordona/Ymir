...
uint64 MC68EC000::Execute() {
    ...
    switch (type) {
    case OpcodeType::Move_EA_EA_B: Instr_Move_EA_EA<uint8>(instr); return 2;
    case OpcodeType::Move_EA_EA_W: Instr_Move_EA_EA<uint16>(instr); return 2;
    case OpcodeType::Move_EA_EA_L: Instr_Move_EA_EA<uint32>(instr); return 2;
    case OpcodeType::Move_EA_CCR: Instr_Move_EA_CCR(instr); return 2;
    case OpcodeType::Move_EA_SR: Instr_Move_EA_SR(instr); return 2;
    case OpcodeType::Move_CCR_EA: Instr_Move_CCR_EA(instr); return 2;
    case OpcodeType::Move_SR_EA: Instr_Move_SR_EA(instr); return 2;
    case OpcodeType::Move_An_USP: Instr_Move_An_USP(instr); return 2;
    case OpcodeType::Move_USP_An: Instr_Move_USP_An(instr); return 2;
    case OpcodeType::MoveA_W: Instr_MoveA<uint16>(instr); return 2;
    case OpcodeType::MoveA_L: Instr_MoveA<uint32>(instr); return 2;
    case OpcodeType::MoveM_EA_Rs_C_W: Instr_MoveM_EA_Rs<uint16, true>(instr); return 2;
    case OpcodeType::MoveM_EA_Rs_C_L: Instr_MoveM_EA_Rs<uint32, true>(instr); return 2;
    case OpcodeType::MoveM_EA_Rs_D_W: Instr_MoveM_EA_Rs<uint16, false>(instr); return 2;
    case OpcodeType::MoveM_EA_Rs_D_L: Instr_MoveM_EA_Rs<uint32, false>(instr); return 2;
    case OpcodeType::MoveM_PI_Rs_W: Instr_MoveM_PI_Rs<uint16>(instr); return 2;
    case OpcodeType::MoveM_PI_Rs_L: Instr_MoveM_PI_Rs<uint32>(instr); return 2;
    case OpcodeType::MoveM_Rs_EA_W: Instr_MoveM_Rs_EA<uint16>(instr); return 2;
    case OpcodeType::MoveM_Rs_EA_L: Instr_MoveM_Rs_EA<uint32>(instr); return 2;
    case OpcodeType::MoveM_Rs_PD_W: Instr_MoveM_Rs_PD<uint16>(instr); return 2;
    case OpcodeType::MoveM_Rs_PD_L: Instr_MoveM_Rs_PD<uint32>(instr); return 2;
    case OpcodeType::MoveP_Ay_Dx_W: Instr_MoveP_Ay_Dx<uint16>(instr); return 2;
    case OpcodeType::MoveP_Ay_Dx_L: Instr_MoveP_Ay_Dx<uint32>(instr); return 2;
    case OpcodeType::MoveP_Dx_Ay_W: Instr_MoveP_Dx_Ay<uint16>(instr); return 2;
    case OpcodeType::MoveP_Dx_Ay_L: Instr_MoveP_Dx_Ay<uint32>(instr); return 2;
    case OpcodeType::MoveQ: Instr_MoveQ(instr); return 2;

    case OpcodeType::Clr_B: Instr_Clr<uint8>(instr); return 2;
    case OpcodeType::Clr_W: Instr_Clr<uint16>(instr); return 2;
    case OpcodeType::Clr_L: Instr_Clr<uint32>(instr); return 2;
    case OpcodeType::Exg_An_An: Instr_Exg_An_An(instr); return 2;
    case OpcodeType::Exg_Dn_An: Instr_Exg_Dn_An(instr); return 2;
    case OpcodeType::Exg_Dn_Dn: Instr_Exg_Dn_Dn(instr); return 2;
    case OpcodeType::Ext_W: Instr_Ext_W(instr); return 2;
    case OpcodeType::Ext_L: Instr_Ext_L(instr); return 2;
    case OpcodeType::Swap: Instr_Swap(instr); return 2;

    case OpcodeType::ABCD_M: Instr_ABCD_M(instr); return 2;
    case OpcodeType::ABCD_R: Instr_ABCD_R(instr); return 2;
    case OpcodeType::NBCD: Instr_NBCD(instr); return 2;
    case OpcodeType::SBCD_M: Instr_SBCD_M(instr); return 2;
    case OpcodeType::SBCD_R: Instr_SBCD_R(instr); return 2;

    case OpcodeType::Add_Dn_EA_B: Instr_Add_Dn_EA<uint8>(instr); return 2;
    case OpcodeType::Add_Dn_EA_W: Instr_Add_Dn_EA<uint16>(instr); return 2;
    case OpcodeType::Add_Dn_EA_L: Instr_Add_Dn_EA<uint32>(instr); return 2;
    case OpcodeType::Add_EA_Dn_B: Instr_Add_EA_Dn<uint8>(instr); return 2;
    case OpcodeType::Add_EA_Dn_W: Instr_Add_EA_Dn<uint16>(instr); return 2;
    case OpcodeType::Add_EA_Dn_L: Instr_Add_EA_Dn<uint32>(instr); return 2;
    case OpcodeType::AddA_W: Instr_AddA<uint16>(instr); return 2;
    case OpcodeType::AddA_L: Instr_AddA<uint32>(instr); return 2;
    case OpcodeType::AddI_B: Instr_AddI<uint8>(instr); return 2;
    case OpcodeType::AddI_W: Instr_AddI<uint16>(instr); return 2;
    case OpcodeType::AddI_L: Instr_AddI<uint32>(instr); return 2;
    case OpcodeType::AddQ_An_W: Instr_AddQ_An<uint16>(instr); return 2;
    case OpcodeType::AddQ_An_L: Instr_AddQ_An<uint32>(instr); return 2;
    case OpcodeType::AddQ_EA_B: Instr_AddQ_EA<uint8>(instr); return 2;
    case OpcodeType::AddQ_EA_W: Instr_AddQ_EA<uint16>(instr); return 2;
    case OpcodeType::AddQ_EA_L: Instr_AddQ_EA<uint32>(instr); return 2;
    case OpcodeType::AddX_M_B: Instr_AddX_M<uint8>(instr); return 2;
    case OpcodeType::AddX_M_W: Instr_AddX_M<uint16>(instr); return 2;
    case OpcodeType::AddX_M_L: Instr_AddX_M<uint32>(instr); return 2;
    case OpcodeType::AddX_R_B: Instr_AddX_R<uint8>(instr); return 2;
    case OpcodeType::AddX_R_W: Instr_AddX_R<uint16>(instr); return 2;
    case OpcodeType::AddX_R_L: Instr_AddX_R<uint32>(instr); return 2;
    case OpcodeType::And_Dn_EA_B: Instr_And_Dn_EA<uint8>(instr); return 2;
    case OpcodeType::And_Dn_EA_W: Instr_And_Dn_EA<uint16>(instr); return 2;
    case OpcodeType::And_Dn_EA_L: Instr_And_Dn_EA<uint32>(instr); return 2;
    case OpcodeType::And_EA_Dn_B: Instr_And_EA_Dn<uint8>(instr); return 2;
    case OpcodeType::And_EA_Dn_W: Instr_And_EA_Dn<uint16>(instr); return 2;
    case OpcodeType::And_EA_Dn_L: Instr_And_EA_Dn<uint32>(instr); return 2;
    case OpcodeType::AndI_EA_B: Instr_AndI_EA<uint8>(instr); return 2;
    case OpcodeType::AndI_EA_W: Instr_AndI_EA<uint16>(instr); return 2;
    case OpcodeType::AndI_EA_L: Instr_AndI_EA<uint32>(instr); return 2;
    case OpcodeType::AndI_CCR: Instr_AndI_CCR(instr); return 2;
    case OpcodeType::AndI_SR: Instr_AndI_SR(instr); return 2;
    case OpcodeType::Eor_Dn_EA_B: Instr_Eor_Dn_EA<uint8>(instr); return 2;
    case OpcodeType::Eor_Dn_EA_W: Instr_Eor_Dn_EA<uint16>(instr); return 2;
    case OpcodeType::Eor_Dn_EA_L: Instr_Eor_Dn_EA<uint32>(instr); return 2;
    case OpcodeType::EorI_EA_B: Instr_EorI_EA<uint8>(instr); return 2;
    case OpcodeType::EorI_EA_W: Instr_EorI_EA<uint16>(instr); return 2;
    case OpcodeType::EorI_EA_L: Instr_EorI_EA<uint32>(instr); return 2;
    case OpcodeType::EorI_CCR: Instr_EorI_CCR(instr); return 2;
    case OpcodeType::EorI_SR: Instr_EorI_SR(instr); return 2;
    case OpcodeType::Neg_B: Instr_Neg<uint8>(instr); return 2;
    case OpcodeType::Neg_W: Instr_Neg<uint16>(instr); return 2;
    case OpcodeType::Neg_L: Instr_Neg<uint32>(instr); return 2;
    case OpcodeType::NegX_B: Instr_NegX<uint8>(instr); return 2;
    case OpcodeType::NegX_W: Instr_NegX<uint16>(instr); return 2;
    case OpcodeType::NegX_L: Instr_NegX<uint32>(instr); return 2;
    case OpcodeType::Not_B: Instr_Not<uint8>(instr); return 2;
    case OpcodeType::Not_W: Instr_Not<uint16>(instr); return 2;
    case OpcodeType::Not_L: Instr_Not<uint32>(instr); return 2;
    case OpcodeType::Or_Dn_EA_B: Instr_Or_Dn_EA<uint8>(instr); return 2;
    case OpcodeType::Or_Dn_EA_W: Instr_Or_Dn_EA<uint16>(instr); return 2;
    case OpcodeType::Or_Dn_EA_L: Instr_Or_Dn_EA<uint32>(instr); return 2;
    case OpcodeType::Or_EA_Dn_B: Instr_Or_EA_Dn<uint8>(instr); return 2;
    case OpcodeType::Or_EA_Dn_W: Instr_Or_EA_Dn<uint16>(instr); return 2;
    case OpcodeType::Or_EA_Dn_L: Instr_Or_EA_Dn<uint32>(instr); return 2;
    case OpcodeType::OrI_EA_B: Instr_OrI_EA<uint8>(instr); return 2;
    case OpcodeType::OrI_EA_W: Instr_OrI_EA<uint16>(instr); return 2;
    case OpcodeType::OrI_EA_L: Instr_OrI_EA<uint32>(instr); return 2;
    case OpcodeType::OrI_CCR: Instr_OrI_CCR(instr); return 2;
    case OpcodeType::OrI_SR: Instr_OrI_SR(instr); return 2;
    case OpcodeType::Sub_Dn_EA_B: Instr_Sub_Dn_EA<uint8>(instr); return 2;
    case OpcodeType::Sub_Dn_EA_W: Instr_Sub_Dn_EA<uint16>(instr); return 2;
    case OpcodeType::Sub_Dn_EA_L: Instr_Sub_Dn_EA<uint32>(instr); return 2;
    case OpcodeType::Sub_EA_Dn_B: Instr_Sub_EA_Dn<uint8>(instr); return 2;
    case OpcodeType::Sub_EA_Dn_W: Instr_Sub_EA_Dn<uint16>(instr); return 2;
    case OpcodeType::Sub_EA_Dn_L: Instr_Sub_EA_Dn<uint32>(instr); return 2;
    case OpcodeType::SubA_W: Instr_SubA<uint16>(instr); return 2;
    case OpcodeType::SubA_L: Instr_SubA<uint32>(instr); return 2;
    case OpcodeType::SubI_B: Instr_SubI<uint8>(instr); return 2;
    case OpcodeType::SubI_W: Instr_SubI<uint16>(instr); return 2;
    case OpcodeType::SubI_L: Instr_SubI<uint32>(instr); return 2;
    case OpcodeType::SubQ_An_W: Instr_SubQ_An<uint16>(instr); return 2;
    case OpcodeType::SubQ_An_L: Instr_SubQ_An<uint32>(instr); return 2;
    case OpcodeType::SubQ_EA_B: Instr_SubQ_EA<uint8>(instr); return 2;
    case OpcodeType::SubQ_EA_W: Instr_SubQ_EA<uint16>(instr); return 2;
    case OpcodeType::SubQ_EA_L: Instr_SubQ_EA<uint32>(instr); return 2;
    case OpcodeType::SubX_M_B: Instr_SubX_M<uint8>(instr); return 2;
    case OpcodeType::SubX_M_W: Instr_SubX_M<uint16>(instr); return 2;
    case OpcodeType::SubX_M_L: Instr_SubX_M<uint32>(instr); return 2;
    case OpcodeType::SubX_R_B: Instr_SubX_R<uint8>(instr); return 2;
    case OpcodeType::SubX_R_W: Instr_SubX_R<uint16>(instr); return 2;
    case OpcodeType::SubX_R_L: Instr_SubX_R<uint32>(instr); return 2;

    case OpcodeType::DivS: Instr_DivS(instr); return 2;
    case OpcodeType::DivU: Instr_DivU(instr); return 2;
    case OpcodeType::MulS: Instr_MulS(instr); return 2;
    case OpcodeType::MulU: Instr_MulU(instr); return 2;

    case OpcodeType::BChg_I_Dn: Instr_BChg_I_Dn(instr); return 2;
    case OpcodeType::BChg_I_EA: Instr_BChg_I_EA(instr); return 2;
    case OpcodeType::BChg_R_Dn: Instr_BChg_R_Dn(instr); return 2;
    case OpcodeType::BChg_R_EA: Instr_BChg_R_EA(instr); return 2;
    case OpcodeType::BClr_I_Dn: Instr_BClr_I_Dn(instr); return 2;
    case OpcodeType::BClr_I_EA: Instr_BClr_I_EA(instr); return 2;
    case OpcodeType::BClr_R_Dn: Instr_BClr_R_Dn(instr); return 2;
    case OpcodeType::BClr_R_EA: Instr_BClr_R_EA(instr); return 2;
    case OpcodeType::BSet_I_Dn: Instr_BSet_I_Dn(instr); return 2;
    case OpcodeType::BSet_I_EA: Instr_BSet_I_EA(instr); return 2;
    case OpcodeType::BSet_R_Dn: Instr_BSet_R_Dn(instr); return 2;
    case OpcodeType::BSet_R_EA: Instr_BSet_R_EA(instr); return 2;
    case OpcodeType::BTst_I_Dn: Instr_BTst_I_Dn(instr); return 2;
    case OpcodeType::BTst_I_EA: Instr_BTst_I_EA(instr); return 2;
    case OpcodeType::BTst_R_Dn: Instr_BTst_R_Dn(instr); return 2;
    case OpcodeType::BTst_R_EA: Instr_BTst_R_EA(instr); return 2;

    case OpcodeType::ASL_I_B: Instr_ASL_I<uint8>(instr); return 2;
    case OpcodeType::ASL_I_W: Instr_ASL_I<uint16>(instr); return 2;
    case OpcodeType::ASL_I_L: Instr_ASL_I<uint32>(instr); return 2;
    case OpcodeType::ASL_M: Instr_ASL_M(instr); return 2;
    case OpcodeType::ASL_R_B: Instr_ASL_R<uint8>(instr); return 2;
    case OpcodeType::ASL_R_W: Instr_ASL_R<uint16>(instr); return 2;
    case OpcodeType::ASL_R_L: Instr_ASL_R<uint32>(instr); return 2;
    case OpcodeType::ASR_I_B: Instr_ASR_I<uint8>(instr); return 2;
    case OpcodeType::ASR_I_W: Instr_ASR_I<uint16>(instr); return 2;
    case OpcodeType::ASR_I_L: Instr_ASR_I<uint32>(instr); return 2;
    case OpcodeType::ASR_M: Instr_ASR_M(instr); return 2;
    case OpcodeType::ASR_R_B: Instr_ASR_R<uint8>(instr); return 2;
    case OpcodeType::ASR_R_W: Instr_ASR_R<uint16>(instr); return 2;
    case OpcodeType::ASR_R_L: Instr_ASR_R<uint32>(instr); return 2;
    case OpcodeType::LSL_I_B: Instr_LSL_I<uint8>(instr); return 2;
    case OpcodeType::LSL_I_W: Instr_LSL_I<uint16>(instr); return 2;
    case OpcodeType::LSL_I_L: Instr_LSL_I<uint32>(instr); return 2;
    case OpcodeType::LSL_M: Instr_LSL_M(instr); return 2;
    case OpcodeType::LSL_R_B: Instr_LSL_R<uint8>(instr); return 2;
    case OpcodeType::LSL_R_W: Instr_LSL_R<uint16>(instr); return 2;
    case OpcodeType::LSL_R_L: Instr_LSL_R<uint32>(instr); return 2;
    case OpcodeType::LSR_I_B: Instr_LSR_I<uint8>(instr); return 2;
    case OpcodeType::LSR_I_W: Instr_LSR_I<uint16>(instr); return 2;
    case OpcodeType::LSR_I_L: Instr_LSR_I<uint32>(instr); return 2;
    case OpcodeType::LSR_M: Instr_LSR_M(instr); return 2;
    case OpcodeType::LSR_R_B: Instr_LSR_R<uint8>(instr); return 2;
    case OpcodeType::LSR_R_W: Instr_LSR_R<uint16>(instr); return 2;
    case OpcodeType::LSR_R_L: Instr_LSR_R<uint32>(instr); return 2;
    case OpcodeType::ROL_I_B: Instr_ROL_I<uint8>(instr); return 2;
    case OpcodeType::ROL_I_W: Instr_ROL_I<uint16>(instr); return 2;
    case OpcodeType::ROL_I_L: Instr_ROL_I<uint32>(instr); return 2;
    case OpcodeType::ROL_M: Instr_ROL_M(instr); return 2;
    case OpcodeType::ROL_R_B: Instr_ROL_R<uint8>(instr); return 2;
    case OpcodeType::ROL_R_W: Instr_ROL_R<uint16>(instr); return 2;
    case OpcodeType::ROL_R_L: Instr_ROL_R<uint32>(instr); return 2;
    case OpcodeType::ROR_I_B: Instr_ROR_I<uint8>(instr); return 2;
    case OpcodeType::ROR_I_W: Instr_ROR_I<uint16>(instr); return 2;
    case OpcodeType::ROR_I_L: Instr_ROR_I<uint32>(instr); return 2;
    case OpcodeType::ROR_M: Instr_ROR_M(instr); return 2;
    case OpcodeType::ROR_R_B: Instr_ROR_R<uint8>(instr); return 2;
    case OpcodeType::ROR_R_W: Instr_ROR_R<uint16>(instr); return 2;
    case OpcodeType::ROR_R_L: Instr_ROR_R<uint32>(instr); return 2;
    case OpcodeType::ROXL_I_B: Instr_ROXL_I<uint8>(instr); return 2;
    case OpcodeType::ROXL_I_W: Instr_ROXL_I<uint16>(instr); return 2;
    case OpcodeType::ROXL_I_L: Instr_ROXL_I<uint32>(instr); return 2;
    case OpcodeType::ROXL_M: Instr_ROXL_M(instr); return 2;
    case OpcodeType::ROXL_R_B: Instr_ROXL_R<uint8>(instr); return 2;
    case OpcodeType::ROXL_R_W: Instr_ROXL_R<uint16>(instr); return 2;
    case OpcodeType::ROXL_R_L: Instr_ROXL_R<uint32>(instr); return 2;
    case OpcodeType::ROXR_I_B: Instr_ROXR_I<uint8>(instr); return 2;
    case OpcodeType::ROXR_I_W: Instr_ROXR_I<uint16>(instr); return 2;
    case OpcodeType::ROXR_I_L: Instr_ROXR_I<uint32>(instr); return 2;
    case OpcodeType::ROXR_M: Instr_ROXR_M(instr); return 2;
    case OpcodeType::ROXR_R_B: Instr_ROXR_R<uint8>(instr); return 2;
    case OpcodeType::ROXR_R_W: Instr_ROXR_R<uint16>(instr); return 2;
    case OpcodeType::ROXR_R_L: Instr_ROXR_R<uint32>(instr); return 2;

    case OpcodeType::Cmp_B: Instr_Cmp<uint8>(instr); return 2;
    case OpcodeType::Cmp_W: Instr_Cmp<uint16>(instr); return 2;
    case OpcodeType::Cmp_L: Instr_Cmp<uint32>(instr); return 2;
    case OpcodeType::CmpA_W: Instr_CmpA<uint16>(instr); return 2;
    case OpcodeType::CmpA_L: Instr_CmpA<uint32>(instr); return 2;
    case OpcodeType::CmpI_B: Instr_CmpI<uint8>(instr); return 2;
    case OpcodeType::CmpI_W: Instr_CmpI<uint16>(instr); return 2;
    case OpcodeType::CmpI_L: Instr_CmpI<uint32>(instr); return 2;
    case OpcodeType::CmpM_B: Instr_CmpM<uint8>(instr); return 2;
    case OpcodeType::CmpM_W: Instr_CmpM<uint16>(instr); return 2;
    case OpcodeType::CmpM_L: Instr_CmpM<uint32>(instr); return 2;
    case OpcodeType::Scc: Instr_Scc(instr); return 2;
    case OpcodeType::TAS: Instr_TAS(instr); return 2;
    case OpcodeType::Tst_B: Instr_Tst<uint8>(instr); return 2;
    case OpcodeType::Tst_W: Instr_Tst<uint16>(instr); return 2;
    case OpcodeType::Tst_L: Instr_Tst<uint32>(instr); return 2;

    case OpcodeType::LEA: Instr_LEA(instr); return 2;
    case OpcodeType::PEA: Instr_PEA(instr); return 2;

    case OpcodeType::Link: Instr_Link(instr); return 2;
    case OpcodeType::Unlink: Instr_Unlink(instr); return 2;

    case OpcodeType::BRA: Instr_BRA(instr); return 2;
    case OpcodeType::BSR: Instr_BSR(instr); return 2;
    case OpcodeType::Bcc: Instr_Bcc(instr); return 2;
    case OpcodeType::DBcc: Instr_DBcc(instr); return 2;
    case OpcodeType::JSR: Instr_JSR(instr); return 2;
    case OpcodeType::Jmp: Instr_Jmp(instr); return 2;

    case OpcodeType::RTE: Instr_RTE(instr); return 2;
    case OpcodeType::RTR: Instr_RTR(instr); return 2;
    case OpcodeType::RTS: Instr_RTS(instr); return 2;

    case OpcodeType::Chk: Instr_Chk(instr); return 2;
    case OpcodeType::Reset: Instr_Reset(instr); return 2;
    case OpcodeType::Stop: Instr_Stop(instr); return 2;
    case OpcodeType::Trap: Instr_Trap(instr); return 2;
    case OpcodeType::TrapV: Instr_TrapV(instr); return 2;

    case OpcodeType::Noop: Instr_Noop(instr); return 2;

    case OpcodeType::Illegal: Instr_Illegal(instr); return 2;
    case OpcodeType::Illegal1010: Instr_Illegal1010(instr); return 2;
    case OpcodeType::Illegal1111: Instr_Illegal1111(instr); return 2;
