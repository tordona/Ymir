...
/**
@file
@brief The entrypoint of the core Ymir library.

Includes all functionality needed to operate the emulator.
...
@remark The emulator currently only supports attaching a single standard Saturn Pad to the ports. More types of
...
Debugging
---------
@remark The debugger is a work in progress and in a flow state. Expect things to change dramatically.
