...
- VDP1: Process framebuffer swap slightly later in the VBlank OUT line. Fixes flickering graphics in PhantasM, Soviet Strike, Virtua Cop 2 and Yellow Brick Road, and corrupted sprites in Marvel Super Heroes (Shuma Gorath's Chaos Dimension move). (#72, #303, #335, #336)
