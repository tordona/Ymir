...
void InputCaptureWidget::DrawInputBindButton(input::InputBind &bind, size_t elementIndex) {
    ...
    if (ImGui::Button(label.c_str(), ImVec2(availWidth, 0))) {
        ...
        case input::Action::Kind::Button: CaptureButton(bind, elementIndex); break;
        case input::Action::Kind::Axis1D: CaptureAxis1D(bind, elementIndex); break;
        case input::Action::Kind::Axis2D: CaptureAxis2D(bind, elementIndex); break;
        }
    }
