...
AboutWindow::AboutWindow(SharedContext &context)
    ...
    m_fontDescs.push_back({
        .name = "Spline Sans",
        .license = licenseOFL,
        .url = "https://github.com/SorkinType/SplineSans",
        .font = context.fonts.sansSerif.medium.regular,
    });
    m_fontDescs.push_back({
        .name = "Spline Sans Mono",
        .license = licenseOFL,
        .url = "https://github.com/SorkinType/SplineSansMono",
        .font = context.fonts.monospace.medium.regular,
    });
    m_fontDescs.push_back({
        .name = "Zen Dots",
        .license = licenseOFL,
        .url = "https://github.com/googlefonts/zen-dots",
        .font = context.fonts.display.small,
    });
}
...
void AboutWindow::Display() {
    ...
    ImGui::SetNextWindowSize(ImVec2(660, 800), ImGuiCond_FirstUseEver);
    ...
    if (ImGui::Begin("About", &Open)) {
        if (ImGui::BeginTabBar("##tabs")) {
                    ...
                    if (ImGui::BeginTable("fonts", 3, kTableFlags)) {
                        ...
                        for (auto &font : m_fontDescs) {
                            ...
                            if (ImGui::IsItemHovered() &&
                                (ImGui::TableGetColumnFlags(0) & ImGuiTableColumnFlags_IsHovered)) {
                                ImGui::BeginTooltip();
            ...
            if (ImGui::BeginTabItem("Acknowledgements")) {
                if (ImGui::BeginChild("##acknowledgements", ImVec2(0, 0), false,
                                      ImGuiWindowFlags_HorizontalScrollbar)) {
                    ImGui::PushFont(m_context.fonts.sansSerif.large.bold);
                    ImGui::TextUnformatted("satemu was made possible by");
                    ImGui::PopFont();
                    ...
                    ackWithAuthor("libyaul-examples", "mrkotfw and contributors",
                    ...
                    ImGui::PushFont(m_context.fonts.sansSerif.large.bold);
                    ImGui::TextUnformatted("Other emulators that inspired satemu");
                    ImGui::PopFont();

                    ackWithAuthor("Mednafen", "various contributors", "https://mednafen.github.io/");
                    ImGui::SameLine();
                    ImGui::TextLinkOpenURL("(libretro git mirror)##mednafen",
                    ...
                    ackWithAuthor("Yabause", "Guillaume Duhamel and contributors",
